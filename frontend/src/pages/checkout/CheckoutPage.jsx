          ...
          <Grid item xs={12} md={8}>
            <Stack spacing={3}>
              ...
              <Paper elevation={0} sx={{ p: 3, borderRadius: 4 }}>
                ...
                <RadioGroup defaultValue="library">
                  <Stack spacing={1}>
                    <Paper variant="outlined" sx={{ p: 1, borderRadius: 2 }}>
                      <FormControlLabel value="library" control={<Radio />} label={
                        <Box>
                          <Typography variant="subtitle2" fontWeight="bold">Central Library Main Gate</Typography>
                          <Typography variant="caption" color="text.secondary">Most popular & safe public spot</Typography>
                        </Box>
                      } />
                    </Paper>
                    <Paper variant="outlined" sx={{ p: 1, borderRadius: 2 }}>
                      <FormControlLabel value="cafe" control={<Radio />} label={
                        <Box>
                          <Typography variant="subtitle2" fontWeight="bold">Student Center Cafeteria</Typography>
                          <Typography variant="caption" color="text.secondary">Best for midday exchanges</Typography>
                        </Box>
                      } />
                    </Paper>
                    <Paper variant="outlined" sx={{ p: 1, borderRadius: 2 }}>
                      <FormControlLabel value="hostel" control={<Radio />} label={
                        <Box>
                          <Typography variant="subtitle2" fontWeight="bold">Hostel Block Common Area</Typography>
                          <Typography variant="caption" color="text.secondary">Verification required at entry</Typography>
                        </Box>
                      } />
                    </Paper>
                  </Stack>
